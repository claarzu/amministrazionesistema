<%-- 
    Document   : birre
    Created on : 23-gen-2017, 10.50.59
    Author     : claar
--%>
        ...
        <div class="generale">
            ...
            <div class="container">
                ...
                <div id="contenutoprodotti">
                     <h1>Birriamo Insieme</h1>
                    <p>Sei entrato nella categoria birre</p>
                    <ul class="prodotti">
                        Lista prodotti:
                        <c:forEach var="merce" items="${prodotti.ListaProdotti}">
                            <li><img src="Immagini/bottbic.jpg" width="300" alt="birra" class="prodotto"></li>  
